...
const ReceptionistDashboard = () => {
    ...
    const [currentVisitorNumber, setCurrentVisitorNumber] = useState(-1);
    ...
    return (
        <Layout>
            ...
            <input
                ...
                onChange={(e) => setShowSignInModal(e.target.checked)}
            ...
            <input
                ...
                id="signOut-modal"
                className="modal-toggle"
                onChange={(e) => setShowSignOutModal(e.target.checked)}
                checked={showSignOutModal}
            />
            ...
            <input
                ...
                id="VistorInfo-modal"
                className="modal-toggle"
                onChange={(e) => setShowVisitorModal(e.target.checked)}
                checked={showVisitorModal}
            />
            ...
            <input
                ...
                id="Upload-modal"
                className="modal-toggle"
                onChange={(e) => setShowUploadPopUp(e.target.checked)}
                checked={showUploadPopUp}
            />
