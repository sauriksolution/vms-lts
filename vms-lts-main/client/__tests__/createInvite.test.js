...
describe("CreateInvite", () => {
    ...
    it("shows an error message with invalid Citizenship ID", async () => {
        render(
            <MockedProvider>
                <CreateInvite />
            </MockedProvider>
        ...
        await user.selectOptions(screen.getByRole("combobox"), ["Citizenship-ID"]);
        ...
        expect(screen.getByText("Invalid Citizenship ID Number")).toBeDefined();
    });
    ...
    it("should show an error message when no visitor name is provided", async () => {
        ...
        // Select Citizenship-ID option from comboxbox
        await user.selectOptions(screen.getByRole("combobox"), ["Citizenship-ID"]);
