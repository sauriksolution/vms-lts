                    ...
                    switch(permission) {
                        case 0:
                            return [
                                ...
                                { content: "Rewards", path: "/profilePage" },
                        ...
                        case 3: // Visitor permission level
                            return [
                                { content: "Dashboard", path: "/visitor/dashboard" },
                                { content: "Visa Application", path: "/visitor/visa-form" },
                                { content: "My Applications", path: "/visitor/applications" },
                                { content: "Profile", path: "/visitor/profile" },
                                { content: "Logout", path: "/login", onClick: () => get().logout() },
                            ];
                    }
