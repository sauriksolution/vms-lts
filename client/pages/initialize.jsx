                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-1">
                        ...
                        <div className="card bg-base-200">
                            <div className="card-body">
                                ...
                                <p>
                                    Number of available seat left in the
                                    building.
                                </p>
                                <div className="card-actions flex items-center justify-start">
                                    <div className="flex items-center space-x-3">
                            ...
                            <div className="card-body">
                                ...
                                <div className="card-actions flex items-center justify-start">
                                    <div className="flex items-center justify-center">
                                        ...
                                        <select className="select select-bordered select-secondary mx-5" name="hours" id="hours" value={hours} onChange={(e) => {
                                        ...
                                        <h1>    :    </h1>
                                        <select className="select select-bordered select-secondary mx-5" name="minutes" id="minutes" value={minutes} onChange={(e) => {
